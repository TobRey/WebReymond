...
**Zugang beim ersten Start:** `tobiasreymond` / `Marihuana420!!`
...
Dann **Upload** → `reymond-cms.zip` hochladen → zurück in den Dateimanager →
...
3. Noch sicherer: den Datenordner ausserhalb von `public_html` legen.
   ...
   ```php
   <?php
   define( 'RC_DATA', '/home/DEINBENUTZER/reymond-daten' );
   ```
