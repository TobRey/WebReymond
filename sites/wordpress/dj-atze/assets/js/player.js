 ...
 *
 * Neue Titel: im Backend unter „Musik“ anlegen – Cover ist das Beitragsbild,
 * Stilrichtung, Dauer und Audiodatei stehen im Feld darunter.
 */
...
(function () {
   ...
   * Titel
   *
   * In WordPress werden sie im Backend unter „Musik“ gepflegt und über
   * wp_localize_script als window.RT_TRACKS übergeben.
   * -------------------------------------------------------------------- */

  var TRACKS = Array.isArray(window.RT_TRACKS) ? window.RT_TRACKS : [];
