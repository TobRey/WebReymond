...
<section class="page-head shell">
	...
	<h1 class="display page-head__title">
		<span class="line-mask"><span data-split><?php esc_html_e( 'Sets', 'reymond-tobias' ); ?></span></span>
	</h1>
...
<?php if ( $rt_first ) : ?>
		...
		<div class="player reveal" data-player>
			<figure class="player__art">
				<img src="<?php echo esc_url( $rt_first['cover'] ); ?>"
					alt="<?php echo esc_attr( sprintf( /* translators: %s: Titel */ __( 'Cover: %s', 'reymond-tobias' ), $rt_first['title'] ) ); ?>" />
				<figcaption class="player__index">01</figcaption>
				<span class="player__live"><i></i> <?php esc_html_e( 'Läuft', 'reymond-tobias' ); ?></span>
			</figure>

			<div class="player__main">
				<p class="player__kicker"><?php esc_html_e( 'Jetzt ausgewählt', 'reymond-tobias' ); ?></p>
				...
				<div
					...
					role="slider"
					tabindex="0"
					aria-label="<?php esc_attr_e( 'Position im Titel', 'reymond-tobias' ); ?>"
					aria-valuemin="0"
					aria-valuemax="100"
					aria-valuenow="0"
				>
				...
				<div class="player__controls">
					<button class="ctrl" type="button" data-prev aria-label="<?php esc_attr_e( 'Vorheriger Titel', 'reymond-tobias' ); ?>">
						<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 5h2v14H6zM20 5v14l-11-7z" /></svg>
					</button>

					<button class="ctrl ctrl--play" type="button" aria-label="<?php esc_attr_e( 'Abspielen', 'reymond-tobias' ); ?>">
					...
					<button class="ctrl" type="button" data-next aria-label="<?php esc_attr_e( 'Nächster Titel', 'reymond-tobias' ); ?>">
						<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M16 5h2v14h-2zM4 5l11 7-11 7z" /></svg>
					</button>

					<label class="player__volume">
						<span class="visually-hidden"><?php esc_html_e( 'Lautstärke', 'reymond-tobias' ); ?></span>
				...
				<p class="player__notice">
					<?php esc_html_e( 'Vorschau – für diesen Titel ist noch keine Audiodatei hinterlegt.', 'reymond-tobias' ); ?>
				</p>
			</div>
		</div>
	</section>
	...
	<section class="section shell" style="padding-top: clamp(2rem, 5vw, 4rem)">
		<p class="eyebrow reveal"><?php esc_html_e( 'Alle Titel', 'reymond-tobias' ); ?></p>
		<div class="tracklist reveal reveal--delay-1" data-tracklist></div>
	</section>
<?php else : ?>
	<section class="section shell">
		<p class="page-head__sub">
			<?php esc_html_e( 'Noch keine Titel angelegt. Im Backend unter „Musik“ Titel hinzufügen.', 'reymond-tobias' ); ?>
		</p>
	</section>
<?php endif; ?>
...
<div class="marquee marquee--reverse" aria-hidden="true">
	<div class="marquee__track">
		<span class="marquee__item marquee__item--outline"><?php esc_html_e( 'Laut aufdrehen', 'reymond-tobias' ); ?></span>
		<span class="marquee__item"><?php esc_html_e( 'Techno', 'reymond-tobias' ); ?></span>
		<span class="marquee__item marquee__item--outline"><?php esc_html_e( 'Dunkel', 'reymond-tobias' ); ?></span>
		<span class="marquee__item"><?php esc_html_e( 'Treibend', 'reymond-tobias' ); ?></span>
	</div>
</div>
...
<section class="cta">
	...
	<div class="shell">
		<h2 class="display cta__title reveal">
			<?php esc_html_e( 'Sound für deine', 'reymond-tobias' ); ?> <em><?php esc_html_e( 'Nacht', 'reymond-tobias' ); ?></em>
		</h2>
		<a class="btn btn--solid" href="<?php echo esc_url( $rt_kont_url ); ?>" data-magnetic>
			<?php esc_html_e( 'Booking anfragen', 'reymond-tobias' ); ?>
