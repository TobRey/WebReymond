...
function rt_register_gig() {
	register_post_type(
		...
		array(
			'labels'        => array(
				'name'          => __( 'Termine', 'reymond-tobias' ),
				'singular_name' => __( 'Termin', 'reymond-tobias' ),
				'add_new'       => __( 'Termin hinzufügen', 'reymond-tobias' ),
				'add_new_item'  => __( 'Neuer Termin', 'reymond-tobias' ),
				'edit_item'     => __( 'Termin bearbeiten', 'reymond-tobias' ),
				'all_items'     => __( 'Alle Termine', 'reymond-tobias' ),
				'menu_name'     => __( 'Termine', 'reymond-tobias' ),
				'not_found'     => __( 'Noch keine Termine angelegt.', 'reymond-tobias' ),
			),
			'public'        => false,
			'show_ui'       => true,
			'show_in_menu'  => true,
...
function rt_gig_meta_box() {
	add_meta_box(
		'rt_gig_details',
		__( 'Angaben zum Termin', 'reymond-tobias' ),
...
function rt_gig_meta_box_html( $post ) {
	...
	?>
	<p>
		<label for="rt_gig_day"><strong><?php esc_html_e( 'Datum', 'reymond-tobias' ); ?></strong></label><br />
		<input type="text" id="rt_gig_day" name="rt_gig_day" value="<?php echo esc_attr( $day ); ?>" placeholder="12.09." />
		<span class="description"><?php esc_html_e( 'Freier Text – auch „TBA“ ist möglich.', 'reymond-tobias' ); ?></span>
	</p>
	<p>
		<label for="rt_gig_place"><strong><?php esc_html_e( 'Ort', 'reymond-tobias' ); ?></strong></label><br />
		<input type="text" id="rt_gig_place" name="rt_gig_place" class="widefat" value="<?php echo esc_attr( $place ); ?>" />
	</p>
	<p>
		<label for="rt_gig_status"><strong><?php esc_html_e( 'Status', 'reymond-tobias' ); ?></strong></label><br />
		<input type="text" id="rt_gig_status" name="rt_gig_status" value="<?php echo esc_attr( $status ); ?>"
			placeholder="<?php esc_attr_e( 'Tickets', 'reymond-tobias' ); ?>" />
	</p>
	<p>
		<label for="rt_gig_link"><strong><?php esc_html_e( 'Verweis', 'reymond-tobias' ); ?></strong></label><br />
		<input type="url" id="rt_gig_link" name="rt_gig_link" class="widefat" value="<?php echo esc_url( $link ); ?>" />
		<span class="description"><?php esc_html_e( 'Leer lassen: der Termin verweist dann auf die Kontaktseite.', 'reymond-tobias' ); ?></span>
	</p>
	<?php
}
