...
<a class="visually-hidden" href="#inhalt"><?php esc_html_e( 'Zum Inhalt springen', 'reymond-tobias' ); ?></a>
...
<header class="site-header">
	<div class="site-header__inner">
		...
		<nav class="nav" aria-label="<?php esc_attr_e( 'Hauptnavigation', 'reymond-tobias' ); ?>">
			<?php rt_nav( 'nav__link' ); ?>
		</nav>

		<button class="burger" type="button" aria-expanded="false" aria-label="<?php esc_attr_e( 'Menü öffnen', 'reymond-tobias' ); ?>">
			<span></span>
			<span></span>
		</button>
	</div>
...
<nav class="menu" aria-label="<?php esc_attr_e( 'Menü', 'reymond-tobias' ); ?>">
