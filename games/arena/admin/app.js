...
const BALANCE_FIELDS = [
  ...
  ['hitInvuln', 'Unverwundbar nach Treffer (s)', 0, 0.05],
  ['maxEnemiesGrowth', 'Gegnergrenze wächst je Zyklus (Faktor)', 1, 0.01],
  ['maxEnemiesLimit', 'Gegnergrenze höchstens (Notbremse)', 10, 10],
  ['eliteFromCycle', 'Elitegegner ab Zyklus', 1, 1],
  ['eliteGrowth', 'Elite-Anteil je Welle (0-1)', 0, 0.01],
  ['eliteMax', 'Elite-Anteil höchstens (0-1)', 0, 0.05],
  ['eliteHealth', 'Elite: Leben ×', 1, 0.1],
  ['eliteDamage', 'Elite: Schaden ×', 1, 0.1],
...
const SHOP_FIELDS = [
  ...
  ['priceCycleGrowth', 'Preiswachstum je Zyklus (Faktor)', 1, 0.01],
