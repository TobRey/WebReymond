...
const FAQ = [
  ...
  [
    ...
    'Nein. AI Groove bringt mit GrooveNet eine eigene KI mit. Sie läuft vollständig im Browser, kostet nichts, braucht keinen Key und funktioniert auch ohne Internet – für Einzelklänge ebenso wie für ganze Schleifen.',
  ],
  [
...
export function createHelpView() {
  ...
  function build() {
    ...
    const aiBtn = h('button.btn.btn--sm', { type: 'button', text: 'KI-Einstellungen' });
