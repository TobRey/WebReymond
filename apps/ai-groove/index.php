...
$csp = implode('; ', [
    ...
    "font-src 'self'",
    // Direktverbindungen zu KI-Anbietern (nur wenn der Nutzer den Direktmodus waehlt).
    "connect-src 'self' blob: https://api.stability.ai https://api.elevenlabs.io",
    "manifest-src 'self'",
]);
