...
export function createSettingsView() {
  ...
  function build() {
    ...
    aiBtn.appendChild(h('span', { text: 'KI verbinden' }));
    ...
    inner.appendChild(
      group('KI-Anbieter', [
        settingRow(
          'Eigener Zugang',
          'AI Groove verwendet ausschliesslich deinen eigenen API-Key. Er wird nie auf dem Server gespeichert.',
          aiBtn,
        ),
      ]),
    );
    ...
    inner.appendChild(
      h('p.field__hint', {
        text: 'AI Groove 1.0.0 · Läuft vollständig in deinem Browser. Keine Konten, keine Projektdaten auf dem Server.',
      }),
    );
